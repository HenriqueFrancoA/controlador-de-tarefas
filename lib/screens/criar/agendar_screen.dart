          ...
          child: Column(
            children: [
              Container(
                ...
                child: Obx(
                  () => TableCalendar(
                    firstDay: diaFoco.value.subtract(const Duration(days: 360)),
                                      ...
                                      try {
                                        if (categoriaNomeController.text !=
                                          ...
                                          Categoria novaCategoria = Categoria(
                                            nome: categoriaNomeController.text,
                                          );
                          ...
                          onChanged: (String? recorrencia) {
                            ...
                            if (recorrenciaSelecionada.value == 'Dias semana') {
                              if (diaFoco.value.weekday == 6 ||
                                ...
                                diaFoco.value =
                                    diaFoco.value.add(const Duration(days: 2));
                              }
                            }
                          },
                          iconEnabledColor:
